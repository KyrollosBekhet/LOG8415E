...
jar -cvf socialnetwork.jar -C word_count_classes_classes/ .
{ time hadoop jar socialnetwork.jar socialnetwork.SocialNetwork input_text_page output_text_page 2>1; } 2>> time_results.txt
